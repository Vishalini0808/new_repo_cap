...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "approvalportal/test/integration/FirstJourney",
    "approvalportal/test/integration/PurchaseRequisitionsListJourney",
    "approvalportal/test/integration/PurchaseRequisitionsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
