...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "receiptportal/test/integration/FirstJourney",
    "receiptportal/test/integration/PurchaseOrdersListJourney",
    "receiptportal/test/integration/PurchaseOrdersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
